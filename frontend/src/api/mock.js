...
const mockChannels = [
  { id: 1, name: '科技', slug: 'tech', description: '技术、科学、AI等理性讨论', icon: '🔬', post_count: 0 },
  { id: 2, name: '哲学', slug: 'philosophy', description: '形而上学、伦理学、逻辑学', icon: '💭', post_count: 0 },
  { id: 3, name: '经济', slug: 'economics', description: '市场、政策、行为经济学', icon: '📊', post_count: 0 },
  { id: 4, name: '社会', slug: 'society', description: '公共议题、社会现象分析', icon: '🏛️', post_count: 0 },
  { id: 5, name: '综合', slug: 'general', description: '无法归类的严肃讨论', icon: '💬', post_count: 0 }
]
...
const initMockPosts = () => {
  mockPosts = [
    {
      id: 1, channel_id: 1, author_id: 1, author_name: '张三', author_level: 3, quality_score: 8.5,
      channel_name: '科技', channel_slug: 'tech', channel_icon: '🔬',
      title: '大语言模型的推理能力是否被高估了？',
      content: '最近GPT-5发布后，很多人认为AGI已经近在咫尺。但我认为我们需要更冷静地看待LLM的推理能力。当前模型在模式匹配上表现出色，但在需要真正的因果推理时仍然存在明显缺陷...',
      thesis: 'LLM的推理能力被严重高估，其本质仍是统计模式匹配',
      sources: [{ url: 'https://arxiv.org/abs/xxx', title: '论文标题', note: '相关研究' }],
      comment_count: 8, view_count: 234, is_pinned: false, status: 0, audit_status: 1,
      created_at: new Date(Date.now() - 3600000).toISOString()
    },
    {
      id: 2, channel_id: 4, author_id: 2, author_name: '李四', author_level: 2, quality_score: 7.2,
      channel_name: '社会', channel_slug: 'society', channel_icon: '🏛️',
      title: '最低工资标准提高对就业市场的实际影响分析',
      content: '基于过去五年中国各省市最低工资调整的数据，我们其实可以看到一些反直觉的现象。最低工资的提升并没有像某些经济学家预测的那样导致大规模失业...',
      thesis: null,
      sources: [],
      comment_count: 15, view_count: 567, is_pinned: false, status: 0, audit_status: 1,
      created_at: new Date(Date.now() - 7200000).toISOString()
    },
    {
      id: 3, channel_id: 2, author_id: 3, author_name: '王五', author_level: 4, quality_score: 9.1,
      channel_name: '哲学', channel_slug: 'philosophy', channel_icon: '💭',
      title: '自由意志存在吗？——从决定论到相容论',
      content: '自由意志问题困扰了哲学家几个世纪。本文将从强决定论、自由意志论和相容论三个角度来审视这个问题。相容论可能是最有希望调和现代科学与道德责任的立场...',
      thesis: '相容论是调和决定论与道德责任的最佳框架',
      sources: [{ url: 'https://plato.stanford.edu/entries/compatibilism/', title: 'SEP: Compatibilism', note: '权威哲学参考' }],
      comment_count: 23, view_count: 891, is_pinned: true, status: 0, audit_status: 1,
      created_at: new Date(Date.now() - 86400000).toISOString()
    },
    {
      id: 4, channel_id: 1, author_id: 1, author_name: '张三', author_level: 3, quality_score: 6.8,
      channel_name: '科技', channel_slug: 'tech', channel_icon: '🔬',
      title: '量子计算离实用化还有多远？',
      content: '最近IBM和Google在量子比特数量上取得了突破，但从NISQ时代到容错量子计算，我们可能还需要至少十年。本文将分析当前的主要技术瓶颈...',
      thesis: '量子计算的实用化至少还需要十年',
      sources: [],
      comment_count: 5, view_count: 320, is_pinned: false, status: 0, audit_status: 1,
      created_at: new Date(Date.now() - 172800000).toISOString()
    },
    {
      id: 5, channel_id: 3, author_id: 2, author_name: '李四', author_level: 2, quality_score: null,
      channel_name: '经济', channel_slug: 'economics', channel_icon: '📊',
      title: '通货膨胀的本质：货币现象还是供给问题？',
      content: '关于通胀的争论从未停止。货币主义学派认为通胀始终是一种货币现象，但近年来的供应链危机似乎提供了一个反例。让我们用数据和理论来审视这个问题...',
      thesis: null,
      sources: [],
      comment_count: 2, view_count: 98, is_pinned: false, status: 0, audit_status: 1,
  ...
  // 初始化评论
  mockComments = [
    { id: 1, post_id: 1, author_id: 2, author_name: '李四', author_level: 2, parent_id: null,
      content: '很好的分析。不过我认为模式匹配和推理能力之间的界限本身就比较模糊。人类的很多推理本质上也是模式匹配。',
      upvote_count: 12, is_deleted: 0, audit_status: 1,
      created_at: new Date(Date.now() - 1800000).toISOString() },
    { id: 2, post_id: 1, author_id: 3, author_name: '王五', author_level: 4, parent_id: 1,
      content: '同意。从认知科学的角度看，人类推理确实大量依赖类比（模式匹配），关键区别在于元认知层面的自我纠错能力。',
      upvote_count: 8, is_deleted: 0, audit_status: 1,
      created_at: new Date(Date.now() - 900000).toISOString() },
    { id: 3, post_id: 3, author_id: 1, author_name: '张三', author_level: 3, parent_id: null,
      content: '推荐丹尼特的《自由的进化》，对相容论有很好的阐释。你引用的SEP条目也是非常好的起点。',
      upvote_count: 5, is_deleted: 0, audit_status: 1,
      created_at: new Date(Date.now() - 43200000).toISOString() },
    { id: 4, post_id: 3, author_id: 2, author_name: '李四', author_level: 2, parent_id: null,
      content: '作为非决定论者，我认为量子力学的不确定性为自由意志提供了物理基础。相容论虽然实用，但回避了核心问题。',
      upvote_count: 3, is_deleted: 0, audit_status: 1,
...
const initMockNotifications = () => {
  mockNotifications = [
    ...
    // 社区通知
    { id: ++mockNotificationId, type: 'comment_reply', content: '王五回复了你的评论', is_read: 0, created_at: new Date(Date.now() - 300000).toISOString() },
    { id: ++mockNotificationId, type: 'post_scored', content: '你的帖子"大语言模型的推理能力"获得了 8.5 分', is_read: 0, created_at: new Date(Date.now() - 900000).toISOString() },
    { id: ++mockNotificationId, type: 'debate_started', content: '你的帖子已升级为辩论', is_read: 1, created_at: new Date(Date.now() - 1800000).toISOString() }
  ]
}
...
export const mockApi = {
  ...
  getPosts: async (params) => {
    ...
    if (params?.sort === 'newest') {
      ...
      list.sort((a, b) => (b.comment_count * 2 + b.view_count * 0.1) - (a.comment_count * 2 + a.view_count * 0.1))
    } else {
    ...
    return {
      code: 200,
      data: { posts: list.slice(start, start + limit), total: list.length, page, limit, hasMore: (start + limit) < list.length }
    }
  },
  ...
  createPost: async (data) => {
    ...
    const newPost = {
      id, channel_id: data.channel_id, author_id: currentUserId || 1,
      author_name: user.name, author_level: user.level || 2,
      channel_name: channel.name, channel_slug: channel.slug, channel_icon: channel.icon,
      title: data.title, content: data.content,
      thesis: data.thesis || null, premises: data.premises || null, sources: data.sources || null,
      comment_count: 0, view_count: 0, quality_score: null,
      is_pinned: false, status: 0, audit_status: 1,
      created_at: new Date().toISOString()
    }
  ...
  togglePin: async (postId) => {
    ...
    return { code: 200, data: { is_pinned: post.is_pinned }, message: post.is_pinned ? '已置顶' : '已取消置顶' }
  },
  ...
  startDebateFromPost: async (postId) => {
    ...
    const newDebate = {
      ...
      publisher_id: currentUserId,
      publisher_name: '当前用户',
      participant_count: 0, heat: 0,
      pro_limit: 5, con_limit: 5,
      created_at: new Date().toISOString(),
      pro_count: 0, con_count: 0, post_id: post.id
    }
    mockDebates.unshift(newDebate)
  ...
  scorePost: async (postId, data) => {
    ...
    post.quality_score = post.quality_score !== null
  ...
  createComment: async (postId, data) => {
    ...
    const user = userStr ? JSON.parse(userStr) : { name: '当前用户', level: 2 }
    const comment = {
      id, post_id: parseInt(postId), author_id: currentUserId || 1,
      author_name: user.name, author_level: user.level || 2,
      parent_id: data.parent_id || null, content: data.content,
      upvote_count: 0, is_deleted: 0, audit_status: 1,
      created_at: new Date().toISOString()
    }
